...
function User() {
	...
	return <>
		...
		{/* card image */}
					...
					<div className="w-full rounded-lg shadow-md base-100 stats">
						...
						{twitter_username && (
							<div className="stat">
								...
								<div className="text-lg stat-value"><a href={`https://twitter/${twitter_username}`} target="_blank" rel="noreferrer">{twitter_username}</a></div>
							</div>
						)}
						</div>	
				</div>
			...
			<div className="w-full pt-5 rounded-lg shadow-md bg-base-100 stats">
				<div className="stat">
